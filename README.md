...
![Footer](documentation\readme\features\footer-section.png)
...
- The font styles in the FitSpace - Routines website were taken from Google Fonts [Shadows Into Light](https://fonts.google.com/specimen/Shadows+Into+Light) and [Montserrat](https://fonts.google.com/specimen/Montserrat)
