    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('focus', models.CharField(choices=[('general_fitness', 'General Fitness'), ('strength', 'Strength'), ('hypertrophy', 'Hypertrophy'), ('weight_loss', 'Weight Loss')], default='general-fitness')),
